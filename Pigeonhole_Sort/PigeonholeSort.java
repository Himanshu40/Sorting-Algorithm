...
class Main
{
    public static void main (String[] args) 
    {
        ...
        System.out.println("\nSorted Array using Pigeonhole sort : ");
        ...
        for(i=0; i<n; i++)
            pigeonhole[arr[i] - mini]++; // frequency of each element (shifted number as there can be negative number so shifted by min) so each number is positive
